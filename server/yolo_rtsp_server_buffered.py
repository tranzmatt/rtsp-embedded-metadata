#!/usr/bin/env python3
"""
YOLO RTSP Server — Frame-buffer synchronized version
Each video frame waits until its YOLO result is ready before being sent.
Minimal changes from the original file.
"""
